    ...
    <footer className="mt-8 text-primary">
      ...
      <div className="w-full flex flex-col items-center px-4 py-8 md:py-12 gap-8">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 text-center">
          ...
          <div className="flex flex-col gap-4">
            <div className="text-xl md:text-2xl">Serviços</div>
            <div>
              <ul className="flex flex-col gap-2">
                {servicos.map((item) => (
          ...
          <div className="flex flex-col gap-4">
            <div className="text-xl md:text-2xl">Contato</div>
      ...
      <div className="w-full flex flex-col items-center px-4 py-4 gap-4">
        <div className="text-sm md:text-base text-center">© 2025 Massa Internet -Todos os direitos reservados</div>
        <div className="text-sm md:text-base text-center">Termos de serviço   |   Políticas de Privacidade</div>
      </div>
